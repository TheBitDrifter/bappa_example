module github.com/TheBitDrifter/bappa_examples

go 1.23.3

replace github.com/TheBitDrifter/coldbrew => ../coldbrew/
...
require (
	github.com/TheBitDrifter/blueprint v0.0.0-main
	github.com/TheBitDrifter/coldbrew v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/TheBitDrifter/table v0.0.0-20241202222727-621c10848124 // indirect
